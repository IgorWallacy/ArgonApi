...
public interface PedidoCompraRepository extends JpaRepository<PedidoCompra, Integer> {
	...
	@Query(value = "select id ,idfornecedor,dataprevisaoentrega,idcondicaopagamento,dataemissao,valortotal,observacao from doks_pedidocompra where id=?1 " , nativeQuery = true)
